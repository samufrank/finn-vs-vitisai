...
class PkgConfig(object):
    ...
    def __init__(self, cfg):
        ...
        self.bitstream = "{}x{}_i{}w{}o{}a{}_{}_{}_{}_{}".format(
            (1 << cfg["LOG_BATCH"]),
            (1 << cfg["LOG_BLOCK"]),
            (1 << cfg["LOG_INP_WIDTH"]),
            (1 << cfg["LOG_WGT_WIDTH"]),
        ...
        if self.TARGET == "de10nano":
            ...
            self.fpga_device = "xczu3eg-sfvc784-1-e"
            self.fpga_family = "zynq-ultrascale+"
            self.fpga_board = None
            self.fpga_board_rev = None
            self.fpga_freq = 200
            self.fpga_per = 5
            self.fpga_log_axi_bus_width = 6  # INT4: 64-bit AXI for sub-128b tile support
