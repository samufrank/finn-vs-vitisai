...
### vta/ (transformer)
- RadioML 2018 transformer — INT4-o8, same checkpoint as FINN-T (3 heads, emb_dim=96, 1 layer, 122k params). 71.80% accuracy (10k samples, SNR ≥ -6 dB), 26.9 FPS (C runner, o32 optimized), 149.3 mJ/inference, 0.153 W dynamic power. 12 VTA GEMMs, CPU handles softmax/BN/residual. Per-stage: 84.9% VTA, 15.1% CPU.
